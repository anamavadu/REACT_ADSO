...
// Definición del componente 'PayrollPage'
const PayrollPage = ({ payrollItems, onAddToPayroll, onRemoveFromPayroll, onReduceQuantity }) => {
...
return (
    ...
    <h2>Tu Nómina</h2>
{/* Condicional para mostrar mensaje si no hay empleados agregados a la nómina */}
    {payrollItems.length === 0 ? (
        <p>No hay empleados agreagados a la nómina.</p>
    ) : (
        <ul>
...
{/* Opción para proceder al pago */}
    <div className="payroll-menu-actions">
        <Link to="/pay-slip">Pagar</Link>
    </div>
    </div>
);
};

// Exportación del componente 'PayrollPage' para su uso en otros archivos
